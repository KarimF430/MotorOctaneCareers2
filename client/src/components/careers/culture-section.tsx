    ...
    <section id="culture" className="py-12 sm:py-16 bg-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4" data-testid="culture-benefit-balance">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-200 font-medium leading-relaxed">Rev up your career without burning out. Flexible hours, remote work, and time for what matters most.</p>
              </div>
            </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700" data-testid="stat-rating">
